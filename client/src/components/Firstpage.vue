...
<template>
    <div class="w-full h-full flex-col">
        ...
        <div class="flex justify-center">
            <input type="text" @keyup.enter="AddData(longUrl)" placeholder="Paste your link."
                class=" border-2 p-2 w-1/3 rounded-lg" v-model="longUrl">
        ...
        <div class="w-full flex-col mt-40">
            <div class="grid grid-cols-4 gap-4 justify-center" v-for="shorten in data">
                ...
                <a :href="host + shorten.short_url" target="_blank" class="mx-3">{{ host + shorten.short_url }}</a>
